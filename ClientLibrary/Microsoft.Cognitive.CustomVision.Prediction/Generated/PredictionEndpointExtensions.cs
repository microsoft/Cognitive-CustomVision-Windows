...
namespace Microsoft.Cognitive.CustomVision.Prediction
{
    ...
    public static partial class PredictionEndpointExtensions
    {
            ...
            /// </param>
            public static HttpOperationResponse<ImagePredictionResultModel> PredictImageUrlWithHttpMessages(this IPredictionEndpoint operations, System.Guid projectId, ImageUrl imageUrl, System.Guid? iterationId = default(System.Guid?), string application = default(string), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Optional. Specifies the name of application using the endpoint
            /// </param>
            public static ImagePredictionResultModel PredictImage(this IPredictionEndpoint operations, System.Guid projectId, Stream imageData, System.Guid? iterationId = default(System.Guid?), string application = default(string))
            {
            ...
            /// Headers that will be added to request.
            /// </param>
            public static HttpOperationResponse<ImagePredictionResultModel> PredictImageWithHttpMessages(this IPredictionEndpoint operations, System.Guid projectId, Stream imageData, System.Guid? iterationId = default(System.Guid?), string application = default(string), Dictionary<string, List<string>> customHeaders = null)
            {
            ...
            /// Optional. Specifies the name of application using the endpoint
            /// </param>
            public static ImagePredictionResultModel PredictImageUrlWithNoStore(this IPredictionEndpoint operations, System.Guid projectId, ImageUrl imageUrl, System.Guid? iterationId = default(System.Guid?), string application = default(string))
            {
